...
public class PolicyHandler {
    ...
    public void wheneverOperationRecordCreated_MaintenanceRecordCreationPolicy(
        @Payload OperationRecordCreated operationRecordCreated
    ) {
        OperationRecordCreated event = operationRecordCreated;
        System.out.println(
            "\n\n##### listener MaintenanceRecordCreationPolicy : " +
            operationRecordCreated +
            "\n\n"
        );
        // Comments //
        //운행 실적 생성 시 관련 유지보수 기록을 자동으로 등록하여 데이터 일관성 유지
