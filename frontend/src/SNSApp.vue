            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        ...
                        to="/vehicleOperations/operationRecords"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        ...
                        to="/dispatchManagements/assignmentRequests"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        ...
                        to="/maintenances/maintenanceRecords"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="expenses"
                        to="/expenseManagements/expenses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="operationSummaries"
                        to="/dashboards/operationSummaries"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        ...
                        to="/dashboards/dashboardMetrics"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                key: 'operationRecords', 
                route: '/vehicleOperations/operationRecords',
                ImageUrl: '',
            },
            { 
                title: '배차 신청', 
                description: 'AssignmentRequest을 관리하는 화면입니다.', 
                key: 'assignmentRequests', 
                route: '/dispatchManagements/assignmentRequests',
                ImageUrl: '',
            },
            { 
                title: '정비 기록', 
                description: 'MaintenanceRecord을 관리하는 화면입니다.', 
                key: 'maintenanceRecords', 
                route: '/maintenances/maintenanceRecords',
                ImageUrl: '',
            },
            { 
                title: '차량 정보', 
                description: 'Vehicle을 관리하는 화면입니다.', 
                key: 'vehicles', 
                route: '/maintenances/vehicles',
                ImageUrl: '',
            },
            { 
                title: '경비', 
                description: 'Expense을 관리하는 화면입니다.', 
                key: 'expenses', 
                route: '/expenseManagements/expenses',
                ImageUrl: '',
            },
            { 
                title: '운행 요약', 
                description: 'OperationSummary을 관리하는 화면입니다.', 
                key: 'operationSummaries', 
                route: '/dashboards/operationSummaries',
                ImageUrl: '',
            },
            { 
                title: '대시보드 지표', 
                description: 'DashboardMetrics을 관리하는 화면입니다.', 
                key: 'dashboardMetrics', 
                route: '/dashboards/dashboardMetrics',
                ImageUrl: '',
            },
