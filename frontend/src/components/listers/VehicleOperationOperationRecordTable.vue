        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <VehicleOperationOperationRecord :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: 
                [
                    { text: "operationId", value: "operationId" },
