<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="OperationId" v-model="item.operationId" :editMode="editMode" @change="change" />
            </div>
            <Driver offline label="Driver" v-model="item.driver" :editMode="false" :key="false" @change="change" />
            <Vehicle offline label="Vehicle" v-model="item.vehicle" :editMode="false" :key="false" @change="change" />
            <div>
                <Number label="TravelDistance" v-model="item.travelDistance" :editMode="editMode" @change="change" />
            </div>
            <div>
