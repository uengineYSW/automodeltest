<template>
    <div style="margin: 0 -15px 0 -15px;">
        <v-list two-line v-if="value.length > 0">
            <v-list-group v-model="isExpansion">
                <template v-slot:activator>
                    <v-list-item-content>
                        <v-list-item-title>CarDetail</v-list-item-title>
                    </v-list-item-content>
                </template>
        ...
        <CarDetail v-if="editMode && tick" offline :isNew="true" :inList="true"
