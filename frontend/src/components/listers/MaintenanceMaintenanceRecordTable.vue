        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <MaintenanceMaintenanceRecord :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "maintenanceDetails", value: "maintenanceDetails" },
                    { text: "maintenanceDate", value: "maintenanceDate" },
                    { text: "status", value: "status" },
                    { text: "car", value: "car" },
                    { text: "operationRecordId", value: "operationRecordId" },
                ],
            maintenanceRecord : [],
            newValue: {},
            tick : true,
